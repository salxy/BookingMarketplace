...
<head>
    <title> El Bet Baytak | Account</title>
...
<form action="checkLogin.php" method="post">
    ...
    <input class="i2" type="password" placeholder="🔒 Password" size="30" name="password" required/>
    <br/><br/>
    <input class="l" type="submit" value="Login"  />
    <br/><br/>
    <input class="i2" type="checkbox" value="remem" checked="checked" > Remember Me</input>
    <a href="forget.php" class="for"> Forgot Password?</a>
<br/>
<br/>
<br/>
    <p class="sign">Not a member already!? <a href="form.php"> Sign Up </a></p>
</div>
</div>
</form>
